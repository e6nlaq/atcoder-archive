...
int main()
{
	...
	rep(i, N)
	{
		...
		if (a < 400)
			tmp = "gray";
		elif (a < 800) tmp = "brown";
		elif (a < 1200) tmp = "green";
		elif (a < 1600) tmp = "cyan";
		elif (a < 2000) tmp = "blue";
		elif (a < 2400) tmp = "yellow";
		elif (a < 2800) tmp = "orange";
		elif (a < 3200) tmp = "red";
	...
	cout << color.size() << spa << color.size() + any << endl;
