...
int main() {
    ...
    while (!q.empty()) {
        ...
        if (t == 0) {
            if (y > 0 && S[x][y - 1] != '#' && dat[1][x][y - 1] == INFLL) {
                dat[1][x][y - 1] = dat[0][x][y] + 1;
                q.push({1, x, y - 1});
            }
            if (y + 1 < W && S[x][y + 1] != '#' && dat[1][x][y + 1] == INFLL) {
                dat[1][x][y + 1] = dat[0][x][y] + 1;
                q.push({1, x, y + 1});
            }
        } else {
            if (x > 0 && S[x - 1][y] != '#' && dat[0][x - 1][y] == INFLL) {
                dat[0][x - 1][y] = dat[1][x][y] + 1;
                q.push({0, x - 1, y});
            }
            if (x + 1 < H && S[x + 1][y] != '#' && dat[0][x + 1][y] == INFLL) {
                dat[0][x + 1][y] = dat[1][x][y] + 1;
                q.push({0, x + 1, y});
            }
        }
    ...
    ll ans = min(dat[0][gx][gy], dat[1][gx][gy]);
