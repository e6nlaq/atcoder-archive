...
int main()
{
	...
	if (S == "tourist")
		co(3858);
	elif (S == "ksun48") co(3679);
	elif (S == "Benq") co(3658);
	elif (S == "Um_nik") co(3648);
	elif (S == "apiad") co(3638);
	elif (S == "Stonefeang") co(3630);
	elif (S == "ecnerwala") co(3613);
	elif (S == "mnbvmar") co(3555);
	elif (S == "newbiedmy") co(3516);
	else co(3481);
